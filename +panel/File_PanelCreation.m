function app = File_PanelCreation(this, hFig)
    ...
    % ## CALLBACKS ##
    %---------------------------------------------------------------------%
    app.Tree.SelectionChangedFcn = {@panel.File_TreeSelectionChanged, this};
    app.Delete.ImageClickedFcn   = {@panel.File_TreeToolbar,          this};
    app.Up.ImageClickedFcn       = {@panel.File_TreeToolbar,          this};
    app.Down.ImageClickedFcn     = {@panel.File_TreeToolbar,          this};
end