...
TabStruct  = struct('HOME',   {{'File'}}, ...
                    'PLOT',   {{'Playback', 'xy-Limits', 'Controls', 'Persistance', 'Occupancy', 'Waterfall'}}, ...
                    'REPORT', {{'Report', 'Detection', 'Findpeaks parameters', 'Classification', 'Miscellaneous'}});
...
CompStruct    = struct('Type',            'Button',        ...
                       ...
                       'Parameters',      struct('Text', sprintf('Open\nFile'), ...
                                                 'Icon', 'Icon.OPEN_24', ...
                                                 'ButtonPushedFcn', 'toolHome_OpenFile'));

CompStruct(end+1) = struct('Type',        'Button',        ...
                       'Group',           '',              ...
                       'appProperty',     0,               ...
                       'appPropertyName', 'toolHome_SpectralData', ...
                       'PositionID',      1121,            ... % "1111" means TAB 1, SECTION 1, COLUMN 1, ROW 1
                       'ColumnWidth',     '40',          ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Text', sprintf('Spectral\nData'),         ...
                                                 'Icon', 'playback_24.png', ...
                                                 'ButtonPushedFcn', 'toolHome_SpectralData'));
...
CompStruct(end+1) = struct('Type',        'Button',        ...
                       ...
                       'Parameters',      struct('Text', 'Play',        ...
                                                 'Icon', 'Icon.RUN_24', ...
                                                 'ButtonPushedFcn', 'toolPlot_Play'));

CompStruct(end+1) = struct('Type',        'DropDownButton', ...
                       'Group',           '',              ...
                       'appProperty',     0,               ...
                       'appPropertyName', 'toolPlot_Save', ...
                       'PositionID',      2121,            ...
                       'ColumnWidth',     '40',          ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Children', struct('Type', 'ListItem', ...
                                                                    'Parameters', struct('Text', 'Export image', ...
                                                                                         'Icon', 'Icon.EXPORT_16', ...
                                                                                         'ItemPushedFcn', 'toolPlot_Save')), ...
                                                 'Text', ' Save ', ...
                                                 'Icon', 'Icon.SAVE_24'));
CompStruct(end).Parameters.Children(2) = struct('Type', 'ListItem', ...
...
CompStruct(end+1) = struct('Type',        'Spinner',       ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [0 6000], 'Value', 0, 'NumberFormat', 'double', 'DecimalFormat', '3f', 'ValueChangedFcn', 'toolPlot_xyLimits'));
...
CompStruct(end+1) = struct('Type',        'Spinner',       ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [-120 0], 'Value', -120, 'NumberFormat', 'double', 'DecimalFormat', '0f', 'ValueChangedFcn', 'toolPlot_xyLimits'));
...
CompStruct(end+1) = struct('Type',        'Spinner',       ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [0 6000], 'Value', 6000, 'NumberFormat', 'double', 'DecimalFormat', '3f', 'ValueChangedFcn', 'toolPlot_xyLimits'));
...
CompStruct(end+1) = struct('Type',        'Spinner',   ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [-120 0], 'Value', 0, 'NumberFormat', 'double', 'DecimalFormat', '0f', 'ValueChangedFcn', 'toolPlot_xyLimits'));
...
CompStruct(end+1) = struct('Type',        'ToggleButton',  ...
                       ...
                       'Parameters',      struct('Text', 'Min Hold',       ...
                                                 'Icon', 'MinHold_16.png', ...
                                                 'ValueChangedFcn', 'toolPlot_Controls'));
...
CompStruct(end+1) = struct('Type',        'DropDown',      ...
                       ...
                       'Parameters',      struct('Items', {{'128', '256', '512', 'full'}}, ...
                                                 'Value', 'full',                          ...
                                                 'ValueChangedFcn', 'toolPlot_Persistance'));
...
CompStruct(end+1) = struct('Type',        'Spinner',   ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [0 100], 'Value', 0, 'NumberFormat', 'double', 'DecimalFormat', '3f', 'ValueChangedFcn', 'toolPlot_Persistance'));
...
CompStruct(end+1) = struct('Type',        'Spinner',   ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [0 100], 'Value', 100, 'NumberFormat', 'double', 'DecimalFormat', '3f', 'ValueChangedFcn', 'toolPlot_Persistance'));
...
CompStruct(end+1) = struct('Type',        'DropDown',      ...
                       ...
                       'Parameters',      struct('Items', {{'linear', 'offset'}}, ...
                                                 'Value', 'linear',                        ...
                                                 'ValueChangedFcn', 'toolPlot_Occupancy'));
...
CompStruct(end+1) = struct('Type',        'Spinner',   ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [-120 0], 'Value', -80, 'NumberFormat', 'double', 'DecimalFormat', '0f', 'ValueChangedFcn', 'toolPlot_Occupancy'));
...
CompStruct(end+1) = struct('Type',        'DropDown',      ...
                       ...
                       'Parameters',      struct('Items', {{'both', 'column', 'row'}}, ...
                                                 'Value', 'both',                      ...
                                                 'ValueChangedFcn', 'toolPlot_Waterfall'));
...
CompStruct(end+1) = struct('Type',        'Spinner',   ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [-120 0], 'Value', -120, 'NumberFormat', 'double', 'DecimalFormat', '0f', 'ValueChangedFcn', 'toolPlot_Waterfall'));
...
CompStruct(end+1) = struct('Type',        'Spinner',   ...
                       ...
                       'ColumnWidth',     '90',            ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Limits', [-120 0], 'Value', 0, 'NumberFormat', 'double', 'DecimalFormat', '0f', 'ValueChangedFcn', 'toolPlot_Waterfall'));
...
CompStruct(end+1) = struct('Type',        'Button',        ...
                       ...
                       'Parameters',      struct('Text', ' Run  ',      ...
                                                 'Icon', 'Icon.RUN_24', ...
                                                 'ButtonPushedFcn', 'toolReport_Run'));
...
CompStruct(end+1) = struct('Type',        'Button',        ...
                       ...
                       'Parameters',      struct('Text', sprintf('Add\nEmission'),      ...
                                                 'Icon', 'Icon.NEW_24', ...
                                                 'ButtonPushedFcn', 'toolReport_AddEmission'));
...
CompStruct(end+1) = struct('Type',        'RadioButton', ...
                       ...
                       'Parameters',      struct('Text', 'Manual ROI', ...
                                                 'Value', false, ...
                                                 'ValueChangedFcn', 'toolReport_DetectionType'));
...
CompStruct(end+1) = struct('Type',        'Button',        ...
                       ...
                       'Parameters',      struct('Text', 'Classification', ...
                                                 'Icon', 'list_16.png', ...
                                                 'ButtonPushedFcn', 'toolReport_Classification'));

CompStruct(end+1) = struct('Type',        'Button',        ...
                       'Group',           '',              ...
                       'appProperty',     0,               ...
                       'appPropertyName', 'toolplot_emissionDatabase', ...
                       'PositionID',      3412,            ...
                       'ColumnWidth',     'auto',          ...
                       'ColumnHorAlign',  'auto',          ...
                       'Parameters',      struct('Text', 'Database', ...
                                                 'Icon', 'database_16.png', ...
                                                 'ButtonPushedFcn', 'toolReport_Database'));
...
CompStruct(end+1) = struct('Type',        'Button',        ...
                       ...
                       'Parameters',      struct('Text', 'Drive-test',     ...
                                                 ...
                                                 'ButtonPushedFcn', 'toolReport_DriveTest'));
